set moduleName fir_Pipeline_VITIS_LOOP_31_1
set isTopModule 0
...
set cdfgNum 3
set C_modelName {fir_Pipeline_VITIS_LOOP_31_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict shift_reg { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
...
set portList { 
	...
	{ acc_2_out sc_out sc_lv 32 signal 0 } 
	{ acc_2_out_ap_vld sc_out sc_logic 1 outvld 0 } 
